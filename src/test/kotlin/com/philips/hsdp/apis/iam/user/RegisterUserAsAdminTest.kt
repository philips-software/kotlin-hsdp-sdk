...
class RegisterUserAsAdminTest : IamUserTestBase() {
    ...
    @Test
    fun `Should return an HttpException when Content-Type header is missing`(): Unit = runBlocking {
        // Given
        val mockedResponse = MockResponse()
            .setResponseCode(415)
    ...
    private val newUser = CreateUserAsAdmin(
        loginId = "loginId",
        password = "password",
        name = UserName(
            family = "family",
