...
import com.philips.hsdp.apis.cdr.domain.sdk.ReadVersionRequest
...
internal class ReadVersionTest : CdrTestBase() {

    private val basicRequest = ReadVersionRequest("Patient", "id", "versionId")
