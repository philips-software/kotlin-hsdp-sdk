...
import com.philips.hsdp.apis.cdr.domain.sdk.DeleteByIdRequest
...
internal class DeleteByIdTest : CdrTestBase() {

    private val basicRequest = DeleteByIdRequest("Patient", "id")
