...
/**
 * Represents platform identity certificate request
 */
@Serializable
@SerialName("CertificateRequest")
data class CertificateRequest(
    /**
     * According to the HSDP API spec, the resourceType field should also be included in a CertificateRequest structure.
     ...
     * and use that to decode a JSON representation to a CertificateRequest structure.
     */
